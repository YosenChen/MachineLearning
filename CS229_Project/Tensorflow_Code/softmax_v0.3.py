...
if PIX == 96:
	...
	kaishu_name = '/Users/Lee/Documents/Courses/CS229/CS229 Project/data_28px/kaishu_28px.csv'
	caoshu_name = '/Users/Lee/Documents/Courses/CS229/CS229 Project/data_28px/caoshu_28px.csv' 
	lishu_name = '/Users/Lee/Documents/Courses/CS229/CS229 Project/data_28px/lishu_28px.csv' 
	xingshu_name = '/Users/Lee/Documents/Courses/CS229/CS229 Project/data_28px/xingshu_28px.csv' 
	zhuanshu_name = '/Users/Lee/Documents/Courses/CS229/CS229 Project/data_28px/zhuanshu_28px.csv' 
...
for iter in range(GRAD_DESC_MAX_ITERATION):
	...
	if iter % (GRAD_DESC_MAX_ITERATION/50) == 0:
		...
		print "iter = " + str(iter) + " / " + str(GRAD_DESC_MAX_ITERATION) 
